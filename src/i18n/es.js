export default {
  ...
  operationCancelled: 'Operación cancelada. Saliendo...',
  ...
  gitNotInstalled: 'git no está instalado en el sistema',
  ...
  baseBranch: '¿Desde qué branch base quieres crear la rama?',
  baseBranchRequired: 'El branch base es requerido',
  ticketId: '¿Cuál es el identificador del ticket?',
  ticketRequired: 'El ticket es requerido',
  changeType: '¿Qué tipo de cambio es?',
  branchExistsLocal: (name) =>
    `La rama "${name}" ya existe localmente. ¿Qué deseas hacer?`,
  switchToIt: 'Cambiarme a ella y continuar',
  cancel: 'Cancelar',
  cancelledOp: 'Operación cancelada.',
  ...
  selectFiles: '¿Cuáles archivos quieres incluir en el commit?',
  ...
  aiProvider: '¿Con qué IA quieres generar la sugerencia de commit?',
  ...
  yesUseIt: 'Sí, usar este',
  modify: 'Modificar',
  commitSuccess: 'Commit realizado correctamente',
  hookBlocked: 'El pre-commit hook bloqueó el commit. ¿Qué deseas hacer?',
  retryHook: 'Ya lo corregí, agrega los cambios y vuelve a intentarlo',
  ...
  commitTypes: {
    ...
    style: 'style — formato, sin cambio de lógica'
  },
  ...
  mergeBranchQuestion: '¿A qué rama deseas hacer merge?',
  ...
  conflictsDetected: '¡Conflictos detectados. Resuélvelos manualmente!',
  ...
  // JIRA ticket
  enterJiraCode: 'Ingresa el código del ticket JIRA:',
  jiraRequired: '¡El código JIRA es requerido!',
  jiraInvalidFormat: 'El código JIRA debe tener el formato',
  ...
  fetchingLatest: 'Obteniendo últimos cambios...',
  ...
  removingLastCommit: 'Eliminando último commit...',
  removeLastConfirm:
    'Esto eliminará el último commit (los cambios se mantienen en staging). ¿Continuar?',
  ...
  addError: 'Error al agregar archivos',
  addSuccess: 'Archivos agregados correctamente',
  selectFilesToStage: '¿Cuáles archivos quieres incluir en el stage?',

  // Install
  settingUpConfig: 'Configurando tu entorno',
  configSaved: 'Configuración guardada',
  missingConfigValues: 'Faltan valores de configuración requeridos.',
  errorWritingConfig: 'Error escribiendo archivo de configuración:',
  currentConfig: 'Configuración actual',
  useThisConfig: '¿Deseas usar esta configuración?',
  ...
  upgradeCheckFailed: 'No se pudo verificar la última versión',
  alreadyLatest: (v) => `Ya tienes la última versión (${v})`,
  ...
  lastCommitFound: (msg) => `Último commit: "${msg}"`,
  lastCommitAction: '¿Qué deseas hacer con este commit?',
