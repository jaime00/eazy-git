export default {
  ...
  ticketId: "Cual es el identificador del ticket? (ej: DPW-0000)",
  ...
  jiraInvalidFormat: "El codigo JIRA debe tener el formato DPW-0000",
  ...
  lastCommitRemoved: "Ultimo commit eliminado correctamente!",
